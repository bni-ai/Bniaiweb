...
export function MemberSignupForm({ inviteToken, defaultEmail }: { inviteToken: string; defaultEmail?: string }) {
    ...
    <form className="space-y-4" onSubmit={handleSignup}>
      ...
      <div className="space-y-1">
        <label className="block text-sm font-medium text-text-1" htmlFor="email">
          會員 Email <span className="text-primary">*</span>
        </label>
        <input
          id="email"
          type="email"
